...
**Scan.** 7 files; frameworks: anthropic-sdk, langgraph; tools found: contribution_limits, create_proposal, get_portfolio, market_data, risk_score, search_methodology, search_policy, search_products, suitability_check, tax_lots; knowledge sources: elasticsearch; side effects: external-post (irreversible). Current topology as implemented: **evaluator_optimizer**.
