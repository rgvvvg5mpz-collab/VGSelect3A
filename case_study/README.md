...
|---|---|---|---|---|---|---|
| [01_call_summarization](01_call_summarization/README.md) | single_call | **Prompt chain (sequential workflow)** | ~26s / 60s (fits) | $0.045 | claude-sonnet-5 | **B** (84.7) |
| [02_robo_advisor](02_robo_advisor/README.md) | evaluator_optimizer | **Router / classifier dispatch** | ~27s / 15s (exceeds) | $0.414 | acme-onprem-70b, claude-haiku-4-5 | **F** (54.1) |
| [03_account_inquiry](03_account_inquiry/README.md) | single_agent | **Single agent with tools** | ~7s / 5s (exceeds) | $0.003 | acme-onprem-70b | **D** (63.8) |
